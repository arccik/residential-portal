...
import { KeyCollectorUncheckedUpdateManyWithoutAuthorizedByNestedInputObjectSchema } from "./KeyCollectorUncheckedUpdateManyWithoutAuthorizedByNestedInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutAprovedResidentsInput> =
  z
    .object({
      id: z
        .union([
      ...
      KeyCollector: z
        .lazy(
          () =>
            KeyCollectorUncheckedUpdateManyWithoutAuthorizedByNestedInputObjectSchema
        )
        .optional(),
    })
    .strict();

export const UserUncheckedUpdateWithoutAprovedResidentsInputObjectSchema =
  Schema;
