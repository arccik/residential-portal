...
const Schema: z.ZodType<Prisma.AnnouncementUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const AnnouncementUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
