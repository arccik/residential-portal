...
const Schema: z.ZodType<Prisma.KeyManagementUncheckedUpdateManyWithoutAuthorizedByNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const KeyManagementUncheckedUpdateManyWithoutAuthorizedByNestedInputObjectSchema =
  Schema;
