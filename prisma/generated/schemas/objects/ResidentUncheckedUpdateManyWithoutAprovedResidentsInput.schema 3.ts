...
const Schema: z.ZodType<Prisma.ResidentUncheckedUpdateManyWithoutAprovedResidentsInput> =
  z
    .object({
      id: z
        .union([
...
export const ResidentUncheckedUpdateManyWithoutAprovedResidentsInputObjectSchema =
  Schema;
