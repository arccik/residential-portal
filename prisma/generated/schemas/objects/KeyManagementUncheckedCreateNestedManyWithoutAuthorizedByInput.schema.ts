...
const Schema: z.ZodType<Prisma.KeyManagementUncheckedCreateNestedManyWithoutAuthorizedByInput> =
  z
    .object({
      create: z
        .union([
...
export const KeyManagementUncheckedCreateNestedManyWithoutAuthorizedByInputObjectSchema =
  Schema;
