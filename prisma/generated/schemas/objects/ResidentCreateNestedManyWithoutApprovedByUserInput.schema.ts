...
const Schema: z.ZodType<Prisma.ResidentCreateNestedManyWithoutApprovedByUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ResidentCreateNestedManyWithoutApprovedByUserInputObjectSchema =
  Schema;
