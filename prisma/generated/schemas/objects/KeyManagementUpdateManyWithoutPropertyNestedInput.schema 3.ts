...
const Schema: z.ZodType<Prisma.KeyManagementUpdateManyWithoutPropertyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const KeyManagementUpdateManyWithoutPropertyNestedInputObjectSchema =
  Schema;
