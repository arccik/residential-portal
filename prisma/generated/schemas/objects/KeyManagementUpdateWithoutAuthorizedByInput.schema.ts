...
import { PropertyUpdateOneRequiredWithoutKeyManagementIdNestedInputObjectSchema } from "./PropertyUpdateOneRequiredWithoutKeyManagementIdNestedInput.schema";
...
const Schema: z.ZodType<Prisma.KeyManagementUpdateWithoutAuthorizedByInput> = z
  .object({
    ...
    property: z
      .lazy(
        () =>
          PropertyUpdateOneRequiredWithoutKeyManagementIdNestedInputObjectSchema
      )
      .optional(),
  })
  .strict();
