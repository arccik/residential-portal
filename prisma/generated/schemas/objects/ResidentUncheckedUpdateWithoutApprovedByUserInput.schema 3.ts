...
const Schema: z.ZodType<Prisma.ResidentUncheckedUpdateWithoutApprovedByUserInput> =
  z
    .object({
      id: z
        .union([
...
export const ResidentUncheckedUpdateWithoutApprovedByUserInputObjectSchema =
  Schema;
