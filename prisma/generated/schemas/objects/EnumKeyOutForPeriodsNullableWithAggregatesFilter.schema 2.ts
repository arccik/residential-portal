...
import { NestedEnumKeyOutForPeriodsNullableWithAggregatesFilterObjectSchema } from "./NestedEnumKeyOutForPeriodsNullableWithAggregatesFilter.schema";
...
const Schema: z.ZodType<Prisma.EnumKeyOutForPeriodsNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const EnumKeyOutForPeriodsNullableWithAggregatesFilterObjectSchema =
  Schema;
