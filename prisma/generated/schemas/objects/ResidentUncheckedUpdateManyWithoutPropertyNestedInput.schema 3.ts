...
const Schema: z.ZodType<Prisma.ResidentUncheckedUpdateManyWithoutPropertyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ResidentUncheckedUpdateManyWithoutPropertyNestedInputObjectSchema =
  Schema;
