...
const Schema: z.ZodType<Prisma.ResidentUncheckedUpdateWithoutPropertyInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ResidentUncheckedUpdateWithoutPropertyInputObjectSchema = Schema;
