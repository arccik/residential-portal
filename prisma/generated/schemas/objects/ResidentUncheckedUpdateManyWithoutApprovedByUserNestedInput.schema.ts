...
const Schema: z.ZodType<Prisma.ResidentUncheckedUpdateManyWithoutApprovedByUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ResidentUncheckedUpdateManyWithoutApprovedByUserNestedInputObjectSchema =
  Schema;
