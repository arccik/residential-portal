...
const Schema: z.ZodType<Prisma.AnnouncementUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AnnouncementUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
