...
import { NestedEnumCollectorTypeNullableWithAggregatesFilterObjectSchema } from "./NestedEnumCollectorTypeNullableWithAggregatesFilter.schema";
...
const Schema: z.ZodType<Prisma.EnumCollectorTypeNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const EnumCollectorTypeNullableWithAggregatesFilterObjectSchema = Schema;
