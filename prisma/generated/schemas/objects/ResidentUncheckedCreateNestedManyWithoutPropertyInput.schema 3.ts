...
const Schema: z.ZodType<Prisma.ResidentUncheckedCreateNestedManyWithoutPropertyInput> =
  z
    .object({
      create: z
        .union([
...
export const ResidentUncheckedCreateNestedManyWithoutPropertyInputObjectSchema =
  Schema;
