...
const Schema: z.ZodType<Prisma.KeyManagementUncheckedUpdateManyWithoutKeyManagementIdInput> =
  z
    .object({
      id: z
        .union([
...
export const KeyManagementUncheckedUpdateManyWithoutKeyManagementIdInputObjectSchema =
  Schema;
