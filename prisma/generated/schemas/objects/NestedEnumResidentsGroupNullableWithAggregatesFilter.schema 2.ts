...
const Schema: z.ZodType<Prisma.NestedEnumResidentsGroupNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumResidentsGroupNullableWithAggregatesFilterObjectSchema =
  Schema;
