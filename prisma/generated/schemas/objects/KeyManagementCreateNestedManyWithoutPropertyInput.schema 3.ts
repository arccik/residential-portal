...
const Schema: z.ZodType<Prisma.KeyManagementCreateNestedManyWithoutPropertyInput> =
  z
    .object({
      create: z
        .union([
...
export const KeyManagementCreateNestedManyWithoutPropertyInputObjectSchema =
  Schema;
